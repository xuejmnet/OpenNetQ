...
namespace OpenNetQ.Logging.FileLogging.Batching
{
    public abstract class BatchingLoggerProvider : ILoggerProvider
    {
        ...
        protected BatchingLoggerProvider(IOptionsMonitor<BatchingLoggerOptions> options)
        {
            ...
            _logLevel = loggerOptions.LogWriteLevel;
        ...
        public bool IsEnabled(LogLevel logLevel)
        {
            return logLevel != LogLevel.None
                   ...
                   && Convert.ToInt32(logLevel) >= Convert.ToInt32(_logLevel);
        }
        ...
        private void Start()
        {
            _messageQueue = _queueSize == null ? new BlockingCollection<LogMessage>(new ConcurrentQueue<LogMessage>()) : new BlockingCollection<LogMessage>(new ConcurrentQueue<LogMessage>(), _queueSize.Value);
