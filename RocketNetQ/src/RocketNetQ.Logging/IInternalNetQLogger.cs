...
namespace RocketNetQ.Logging
{
    ...
    /// </summary>
    public interface IInternalNetQLogger
    {
        /// <summary>
        ///     Return the name of this <see cref="IInternalNetQLogger" /> instance.
        /// </summary>
        ...
        bool IsEnabled(InternalNetQLogLevel level);

        /// <summary>
        ///     Log a message object at a specified <see cref="InternalNetQLogLevel" />.
        /// </summary>
        /// <param name="level">log level</param>
        /// <param name="msg">the message object to be logged</param>
        void Log(InternalNetQLogLevel level, string msg);

        /// <summary>
        ///     Log a message at a specified <see cref="InternalNetQLogLevel" /> according to the specified format and
        ///     argument.
        ///     <para>
        ///         This form avoids superfluous object creation when the logger is disabled
        ///         for the specified <see cref="InternalNetQLogLevel" />.
        ///     </para>
        /// </summary>
        /// <param name="level">log level</param>
        /// <param name="format">the format string</param>
        /// <param name="arg">the argument</param>
        void Log(InternalNetQLogLevel level, string format, object arg);
        ...
        /// <param name="argA">the first argument</param>
        /// <param name="argB">the second argument</param>
        void Log(InternalNetQLogLevel level, string format, object argA, object argB);
        ...
        ///         <see cref="Log(InternalNetQLogLevel, string, object)" /> and
        ///         <see cref="Log(InternalNetQLogLevel, string, object, object)" /> arguments exist solely
        ...
        /// <param name="format">the format string</param>
        /// <param name="arguments">an array of arguments</param>
        void Log(InternalNetQLogLevel level, string format, params object[] arguments);

        /// <summary>
        ///     Log an exception at the specified <see cref="InternalNetQLogLevel" /> with an
        ///     accompanying message.
        /// </summary>
        /// <param name="level">log level</param>
        /// <param name="msg">the message accompanying the exception</param>
        /// <param name="t">the exception to log</param>
        void Log(InternalNetQLogLevel level, string msg, Exception t);

        /// <summary>
        ///     Log an exception at the specified <see cref="InternalNetQLogLevel" />.
        /// </summary>
        /// <param name="level">log level</param>
        /// <param name="t">the exception to log</param>
        void Log(InternalNetQLogLevel level, Exception t);
    }
}